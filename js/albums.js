...
$.ajax(settings).done(function (response) {
	console.log(response)	
				...
				for (x in response.data){			
					$('#albums').append('<a class="post"><img class="thumb" title="'+response.data[x].title+'" src="https://i.imgur.com/'+response.data[x].cover+'m.jpg" data-source="'+response.data[x].id+'"></a>');
